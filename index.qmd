...
![Study sites](../Data/03_figures/sites_of_NIES.png){#fig-site_map}
The map demonstrates that llll


### Study data and data analysis

![Measured data summary](~/WORK/Research/Data/03_tables/table_data_NIES.png){#tbl-data_sum}

@tbl-data_sum summarises the data.
