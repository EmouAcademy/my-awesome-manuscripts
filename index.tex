...
See Figure~\ref{fig-elephant} djjd

\begin{figure}

\centering{

\includegraphics{../Data/03_figures/sites_of_NIES.png}

}

\caption{\label{fig-elephant}Study sites}
...
\caption{\label{tbl-letters}Data}

\centering{

\includegraphics{../Data/03_tables/table_data_NIES.png}

}

\end{table}%

Table~\ref{tbl-letters} djjdjdjjdj
